...
/**
 * Handles GET requests for the /api/account/proctor-application/government-id-file route.
 *
...
export async function GET(request: Request) {
  ...
  if (!parsed || !parsed.objectName.startsWith(`proctor-applications/${userId}/government-ids/`)) {
